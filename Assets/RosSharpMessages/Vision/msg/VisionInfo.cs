...
{
    public class VisionInfo : Message
    {
        public override string RosMessageName => "vision_msgs/VisionInfo";
        ...
        public VisionInfo(Header header, string method, string database_location, int database_version)
        {
            this.header = header;
            this.method = method;
